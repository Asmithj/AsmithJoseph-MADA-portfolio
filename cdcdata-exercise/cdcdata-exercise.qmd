...
install.packages(c("httr", "jsonlite", "readr"), dependencies = TRUE)




```{r setup, include=FALSE}
knitr::opts_knit$set(root.dir = "C:/Users/ajose35/Desktop/Ecole/MADA-course/AsmithJoseph-MADA-portfolio")
```
...
# Define the local file path using double backslashes
...
download.file(csv_url, local_path)

# Read the CSV file (Optional step to check if it downloaded correctly)
